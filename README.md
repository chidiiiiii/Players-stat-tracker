...
The application uses a JSON file (`/api/players.json`) as a simulated API endpoint.
...
- **id**: Internal unique identifier for every player. I made sure to differentiate from the jerseynumber.
